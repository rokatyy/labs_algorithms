...
print('nm', nm_res, loss(nm_res.x))
res_lm = least_squares(errfunc, popt, args=([Y]), method='lm', max_nfev=1000)
print('lm', res_lm, loss(res_lm.x))
res_lm_1 = leastsq(errfunc, popt, args=(Y), maxfev=1000)
print('lm1', res_lm_1, loss(res_lm_1[0]))
